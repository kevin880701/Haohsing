...
import com.clockworkorange.domain.data.DataStorePreferenceStorage
...
object PreferencesStorageModule {
    ...
    val Context.dataStore by preferencesDataStore(name = DataStorePreferenceStorage.PREFS_NAME)
