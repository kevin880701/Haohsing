...
import com.clockworkorange.haohsing.databinding.ActivityEngineerMainBinding
...
@AndroidEntryPoint
class EngineerMainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityEngineerMainBinding.inflate(layoutInflater)
